...
export const translations: Record<string, Record<string, string>> = {
  ...
  cs: {
    ...
    compressionLabel: "Kompresní úroveň",
    compressionNone: "Bez komprese",
    compressionFast: "Rychlá",
    compressionBalanced: "Vyvážená",
    compressionMax: "Maximální",
  ...
  de: {
    ...
    compressionNone: "Keine Komprimierung",
    compressionFast: "Schnell",
    compressionBalanced: "Ausgewogen",
    compressionMax: "Maximal",
