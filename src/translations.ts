...
export const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    compressionFast: "Fast (Deflate level 1)",
    compressionBalanced: "Balanced (Deflate level 6)",
    compressionMax: "Max (Deflate level 9, slowest)",
  ...
  cs: {
    ...
    compressionNone: "Bez komprese (nejrychlejší, největší)",
    compressionFast: "Rychlá (Deflate úroveň 1)",
    compressionBalanced: "Vyvážená (Deflate úroveň 6)",
    compressionMax: "Maximální (Deflate úroveň 9, nejpomalejší)",
  ...
  de: {
    ...
    compressionNone: "Keine Kompression (schnellste, größte)",
    compressionFast: "Schnell (Deflate Stufe 1)",
    compressionBalanced: "Ausgewogen (Deflate Stufe 6)",
    compressionMax: "Maximal (Deflate Stufe 9, langsamste)",
